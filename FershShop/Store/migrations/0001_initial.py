# Generated by Django 2.1.1 on 2019-07-29 07:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_state', models.IntegerField(default=1, verbose_name='商品状态')),
            ],
        ),
        migrations.CreateModel(
            name='GoodsImg',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=32, null=True, verbose_name='昵称')),
        ...
        migrations.AddField(
            model_name='goods',
            name='store_id',
            field=models.ManyToManyField(to='Store.Store', verbose_name='店铺名称'),
        ),
    ]
